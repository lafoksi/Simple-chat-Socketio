...
const Index: React.FC = () => {
  ...
  return (
    <div tw="flex flex-col w-full h-screen">
      <div tw="py-4 text-white bg-gray-900 sticky top-0">
        <h2 tw="mt-2 text-center">Nextjs and socketio</h2>
      </div>
      <div tw="flex flex-col flex-1 bg-gray-400">
        ...
        <div tw="bg-gray-900 p-4 h-20 sticky bottom-0">
          <div tw="flex flex-row flex-1 h-full divide-gray-200 divide-x">
            <div tw="pr-2 flex-1">
              <input
                ...
                tw="w-full h-full rounded shadow bg-gray-300 border px-2"
                disabled={!connected}
                onChange={(e) => {
            ...
            <div tw="flex flex-col justify-center items-stretch pl-2">
              <button
                tw="bg-gray-500 rounded shadow text-sm text-white h-full px-2 w-32 rounded-full"
                onClick={sendMessage}
                disabled={!connected}
              >
                Send
